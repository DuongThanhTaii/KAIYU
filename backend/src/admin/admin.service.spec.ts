...
describe('AdminService', () => {
    ...
    describe('updateSubtitle', () => {
        ...
        it('should update subtitle metadata and tokens', async () => {
            mockPrisma.subtitle.update.mockResolvedValue({ id: subtitleId, ...updateData });
        ...
        it('should correctly reorder tokens when positions are changed', async () => {
            ...
            const reorderedTokens = [
                { hanzi: 'A', position: 0, pinyin: 'A', meaning: '', hskLevel: 1, partOfSpeech: 'n' },
                { hanzi: 'B', position: 1, pinyin: 'B', meaning: '', hskLevel: 1, partOfSpeech: 'v' },
            ];
