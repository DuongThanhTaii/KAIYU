...
import { IsString, IsOptional, IsNumber, IsArray, Min, Max, IsObject, ValidateNested } from 'class-validator';
...
export class ExampleSentenceDto {
    ...
    @ApiProperty({ description: 'Vietnamese translation', example: 'Tôi là học sinh' })
    @IsString()
    vietnamese: string;
}
...
export class MeaningEntryDto {
    ...
    @ApiProperty({ description: 'Array of meanings for this reading', example: ['tốt', 'đẹp', 'khỏe'] })
    @IsArray()
    @IsString({ each: true })
    meanings: string[];
}
...
export class CreateVocabularyDto {
    ...
    @ApiProperty({ description: 'Primary pinyin with tone marks', example: 'hǎo' })
    @IsString()
    pinyin: string;

    @ApiProperty({ description: 'Primary Vietnamese meaning (also generated from meanings array)', example: 'tốt, thích' })
    @IsString()
    meaningVi: string;

    @ApiPropertyOptional({ description: 'English meaning (optional)', example: 'good, to like' })
    @IsString()
    @IsOptional()
    meaningEn?: string;
    ...
    @ApiPropertyOptional({ description: 'Radical meaning in Vietnamese', example: 'nữ, phụ nữ' })
    @IsString()
    @IsOptional()
    ...
    @ApiPropertyOptional({ description: 'Part of speech (for simple single-meaning words)', example: 'adj' })
    @IsString()
    @IsOptional()
    partOfSpeech?: string;
    ...
    @ApiPropertyOptional({ description: 'Example sentences', type: [ExampleSentenceDto] })
    @IsArray()
...
export class UpdateVocabularyDto {
    ...
    @ApiPropertyOptional({ description: 'Pinyin with tone marks', example: 'hǎo' })
    @IsString()
    @IsOptional()
    pinyin?: string;

    @ApiPropertyOptional({ description: 'Vietnamese meaning', example: 'tốt, thích' })
    @IsString()
    @IsOptional()
    meaningVi?: string;

    @ApiPropertyOptional({ description: 'English meaning', example: 'good, to like' })
    @IsString()
    @IsOptional()
    meaningEn?: string;
