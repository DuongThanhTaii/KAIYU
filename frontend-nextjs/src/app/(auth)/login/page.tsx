...
function LoginPageContent() {
  ...
  const [savedProgress, setSavedProgress] = useState<RecentProgress | null>(
    null,
  );
          ...
          <div className="hidden lg:flex lg:col-span-5 relative flex-col justify-between overflow-hidden rounded-2xl bg-surface-dark border border-border-color p-8 group">
            ...
            <div
              ...
              style={{
                ...
                mixBlendMode:
                  "var(--texture-mix-blend)" as CSSProperties["mixBlendMode"],
            ...
            <div className="relative z-10 max-w-md mx-auto flex flex-col h-full justify-center">
              ...
              <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
                ...
                <div className="space-y-2">
                  <label
                    className="block text-sm font-bold text-text-base ml-2"
                    htmlFor="email"
                  >
                    Email
                  </label>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center ml-2">
                    <label
                      className="block text-sm font-bold text-text-base"
                      htmlFor="password"
                    >
                      Mật khẩu
                    </label>
              ...
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none">
                  ...
                  />
                  <path
                    d="M5.50253 14.3003C5.00236 12.8099 5.00236 11.1961 5.50253 9.70575V6.61481H1.5166C-0.18551 10.0056 -0.18551 14.0004 1.5166 17.3912L5.50253 14.3003Z"
                    fill="#FBBC05"
                  />
                  <path
                    d="M12.24 4.74966C13.9509 4.7232 15.6044 5.36697 16.8434 6.54867L20.2695 3.12262C18.1001 1.0855 15.2208 -0.034466 12.24 0.000808666C7.7029 0.000808666 3.55371 2.55822 1.5166 6.61481L5.50253 9.70575C6.45064 6.86173 9.10947 4.74966 12.24 4.74966Z"
                    fill="#EA4335"
                  />
                </svg>
