            ...
            <div className="space-y-4 sm:space-y-6">
                ...
                <div className="bg-surface-dark rounded-xl border border-border-color p-4 sm:p-6 opacity-60 shadow-sm transition-all hover:opacity-100 group">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="min-w-0">
                            <h2 className="text-lg font-bold text-text-base mb-1">Cài đặt chung</h2>
                ...
                <div className="bg-surface-dark rounded-xl border border-border-color p-4 sm:p-6 opacity-60 shadow-sm transition-all hover:opacity-100 group">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="min-w-0">
                            <h2 className="text-lg font-bold text-text-base mb-1">Thanh toán & Gói cước</h2>
                            <p className="text-sm text-text-muted">
                ...
                <div className="bg-surface-dark rounded-xl border border-border-color p-4 sm:p-6 opacity-60 shadow-sm transition-all hover:opacity-100 group">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="min-w-0">
                            <h2 className="text-lg font-bold text-text-base mb-1">Thông báo & Email</h2>
                            <p className="text-sm text-text-muted">
