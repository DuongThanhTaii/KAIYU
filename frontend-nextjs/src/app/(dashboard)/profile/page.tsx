  ...
  return (
    <DashboardLayout>
      <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
        <h2 className="text-xl sm:text-2xl font-bold text-text-base mb-6 sm:mb-8 uppercase tracking-wider opacity-80">
          Hồ sơ cá nhân
        </h2>
        ...
        <div className="bg-surface-dark rounded-3xl border border-border-color p-6 sm:p-8 mb-6 shadow-sm relative overflow-hidden transition-colors">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
            ...
            <div className="relative shrink-0">
              <div
                className={`size-24 rounded-full bg-gradient-to-br from-primary to-primary-hover flex items-center justify-center text-4xl font-bold text-on-primary overflow-hidden ${
                  isEditing
            ...
            <div className="flex-1 text-center sm:text-left min-w-0">
              {isEditing ? (
                ...
                <>
                  <h2 className="text-2xl font-bold text-text-base mb-1 truncate">
                    {displayName}
                  </h2>
                  <p className="text-text-secondary font-medium mb-4 truncate">
                    {user?.email}
                  </p>
                  <div className="flex items-center justify-center sm:justify-start gap-3 flex-wrap">
                    <span
                      className={`px-4 py-1.5 text-xs font-black uppercase tracking-wider rounded-full ${
                        user?.role === "admin"
